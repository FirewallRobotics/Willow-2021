...
public class Shooter extends Subsystem {
    ...
    public Shooter() {
        // Factory default the Talons before configuring
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new ShooterManualCommand());
    }
    ...
    public static void shoot(double triggerAxis) {
            Shooter.set(RobotMap.SHOOTER_SPEED);
            //Shooter2.set(RobotMap.SHOOTER_SPEED);
        }    
