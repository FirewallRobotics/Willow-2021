...
public class Shooter extends Subsystem {
    private WPI_TalonSRX Turret = new WPI_TalonSRX(5);
    private WPI_VictorSPX Shooter = new WPI_VictorSPX(6);
    private WPI_VictorSPX Shooter2 = new WPI_VictorSPX(7);
    private final AS5600EncoderPwm encoder = new
    AS5600EncoderPwm(Turret.getSensorCollection());
