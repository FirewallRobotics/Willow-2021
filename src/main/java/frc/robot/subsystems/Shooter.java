...
public class Shooter extends Subsystem {
    private static WPI_TalonSRX Turret = new WPI_TalonSRX(5);
    private static WPI_VictorSPX Shooter = new WPI_VictorSPX(6);
    private static WPI_VictorSPX Shooter2 = new WPI_VictorSPX(7);
