...
public class Shooter extends Subsystem {
    ...
    private WPI_VictorSPX Shooter = new WPI_VictorSPX(RobotMap.FIRST_SHOOTER_ADDRESS);
    private WPI_VictorSPX Shooter2 = new WPI_VictorSPX(RobotMap.SECOND_SHOOTER_ADDRESS);
