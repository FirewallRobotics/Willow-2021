...
public static LogicEngine logicEngine;
...
String[] driveChoiceList = {"TankDrive", "CurvatureDrive", "ArcadeDrive"};
SmartDashboard.putStringArray("Drive Choice List", driveChoiceList);
